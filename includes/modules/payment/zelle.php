...
class zelle extends base
{
    ...
    public function __construct() 
    {
        ...
        $this->sort_order = defined('MODULE_PAYMENT_ZELLE_SORT_ORDER') ? MODULE_PAYMENT_ZELLE_SORT_ORDER : null;

        if (null === $this->sort_order) return false;
        
        $this->enabled = (MODULE_PAYMENT_ZELLE_STATUS == 'True');
    ...
    public function update_status() 
    {
        ...
        // -----
        // No pay-to?  Auto-disable, since there's no place to send the funds!
        //
        if (MODULE_PAYMENT_ZELLE_PAYTO == '') {
            $this->enabled = false;
        }
    ...
    {
        return array('title' => MODULE_PAYMENT_ZELLE_TEXT_DESCRIPTION);
    }
    ...
    public function install() 
    {
        ...
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION . " 
             ...
             VALUES 
                ('Enable Zelle&reg; Payment Module', 'MODULE_PAYMENT_ZELLE_STATUS', 'True', 'Do you want to accept payments via Zelle&reg;?', 6, 1, NULL, 'zen_cfg_select_option(array(\'True\', \'False\'), ', now()),
